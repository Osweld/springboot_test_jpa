...
import com.example.springboot_test.repository.BancoRepository;
...
//    //es necesario que sea la clase no la interfaz
//    @InjectMocks
...
//        Datos.BANCO.setTotalTransferencia(0);
    ...
    void contextLoads2() {
        ...
        //Ya que son clases finales dan problemas ya que no serian pruebas unitarias
        when(cuentaRepository.findById(1L)).thenReturn(crearCuenta001());
        when(cuentaRepository.findById(2L)).thenReturn(crearCuenta002());
        when(bancoRepository.findById(1L)).thenReturn(crearBanco());
